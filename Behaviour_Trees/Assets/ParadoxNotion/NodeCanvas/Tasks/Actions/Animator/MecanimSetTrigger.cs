...
namespace NodeCanvas.Tasks.Actions
{
    ...
    public class MecanimSetTrigger : ActionTask<Animator>
    {
        ...
        protected override string info => string.Format("Mec.SetTrigger {0}", string.IsNullOrEmpty(parameter.value) && !parameter.useBlackboard ? parameterHashID.ToString() : parameter.ToString());
